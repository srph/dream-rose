...
class PropagandaComposer {
	 ...
	 * @return 	void
	 */
	protected function cacheNews($expiration = 10, $offset = 3)
	{
		$news = $this->news
			->getByType('news')
			->orderBy('id', 'desc')
	 ...
	 * @return 	void
	 */
	protected function cacheUpdates($expiration = 10, $offset = 5)
	{
		$updates = $this->news
			->getByType('updates')
			->orderBy('id', 'desc')
	 ...
	 * @return 	void
	 */
	protected function cacheEvents($expiration = 10, $offset = 5)
	{
		$events = $this->news
			->getByType('events')
			->orderBy('id', 'desc')
	 ...
	 * @return 	void
	 */
	protected function cacheSlides($expiration = 10, $offset = 5)
	{
		$slides = $this->slide
			->orderBy('id', 'desc')
			->take($offset)
